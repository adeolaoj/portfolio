...
var GlassCard = React4.forwardRef(
  ({
    children,
    variant,
    padding,
...
var glassButtonVariants = classVarianceAuthority.cva(
  // Base styles
  [
...
var GlassButton = React4.forwardRef(
  ({
    children,
    variant,
    size,
...
var glassInputVariants = classVarianceAuthority.cva(
  [
...
var GlassInput = React4.forwardRef(
  ({
    label,
    helperText,
    error,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cn("flex flex-col gap-1.5", fullWidth && "w-full", containerClassName), children: [
      label && /* @__PURE__ */ jsxRuntime.jsx("label", { htmlFor: inputId, className: "text-sm font-medium text-white/80", children: label }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative", children: [
        leftIcon && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-white/50", children: leftIcon }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "input",
          {
            ref,
        ...
        isPassword ? /* @__PURE__ */ jsxRuntime.jsx(
          "button",
          {
            ...
            children: showPassword ? /* @__PURE__ */ jsxRuntime.jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntime.jsx(
              "path",
              {
                strokeLinecap: "round",
            ...
            ) }) : /* @__PURE__ */ jsxRuntime.jsxs("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: [
              /* @__PURE__ */ jsxRuntime.jsx(
                "path",
                {
                  strokeLinecap: "round",
        ...
        ) : rightIcon ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute right-3 top-1/2 -translate-y-1/2 text-white/50", children: rightIcon }) : null
      ] }),
...
var glassTextareaVariants = classVarianceAuthority.cva(
  [
    "w-full bg-glass-card/50 backdrop-blur-glass",
    "border border-white/12 rounded-xl",
    "text-white placeholder:text-white/40",
...
var GlassTextarea = React4.forwardRef(
  ({
    label,
    helperText,
    error,
    ...
    const [charCount, setCharCount] = React4.useState(
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cn("flex flex-col gap-1.5", fullWidth && "w-full", containerClassName), children: [
      label && /* @__PURE__ */ jsxRuntime.jsx("label", { htmlFor: textareaId, className: "text-sm font-medium text-white/80", children: label }),
      /* @__PURE__ */ jsxRuntime.jsx(
        "textarea",
        {
          ref,
...
var glassSelectTriggerVariants = classVarianceAuthority.cva(
  [
...
var SelectIcon = () => /* @__PURE__ */ jsxRuntime.jsx(
  "svg",
  {
...
var GlassSelect = React4.forwardRef(
  ({
    label,
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(SelectPrimitive__namespace.Root, { disabled, ...props, children: [
            /* @__PURE__ */ jsxRuntime.jsxs(
              SelectPrimitive__namespace.Trigger,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsx(SelectPrimitive__namespace.Icon, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(SelectIcon, {}) })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntime.jsx(SelectPrimitive__namespace.Portal, { children: /* @__PURE__ */ jsxRuntime.jsx(
              SelectPrimitive__namespace.Content,
              {
                ...
                position: "popper",
                sideOffset: 4,
                children: /* @__PURE__ */ jsxRuntime.jsx(SelectPrimitive__namespace.Viewport, { className: "p-1", children: options.map((option) => /* @__PURE__ */ jsxRuntime.jsxs(
                  SelectPrimitive__namespace.Item,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntime.jsx(SelectPrimitive__namespace.ItemIndicator, { className: "absolute right-2", children: /* @__PURE__ */ jsxRuntime.jsx(CheckIcon, {}) })
                    ]
                  },
                  option.value
                )) })
...
var glassCheckboxVariants = classVarianceAuthority.cva(
  [
...
var GlassCheckbox = React4.forwardRef(
  ({
    label,
    description,
    checkboxSize = "md",
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cn("flex items-start gap-3", containerClassName), children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        CheckboxPrimitive__namespace.Root,
        {
          ...
          ...props,
          children: /* @__PURE__ */ jsxRuntime.jsx(CheckboxPrimitive__namespace.Indicator, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntime.jsx(CheckIcon2, { size: checkboxSize || "md" }) }) })
        }
      ),
...
var glassSwitchVariants = classVarianceAuthority.cva(
  [
...
var glassSwitchThumbVariants = classVarianceAuthority.cva(
  [
...
var GlassSwitch = React4.forwardRef(
  ({
    label,
    description,
    switchSize = "md",
    ...
    const switchId = id || `glass-switch-${Math.random().toString(36).substr(2, 9)}`;
    const LabelContent = () => (label || description) && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-0.5", children: [
      label && /* @__PURE__ */ jsxRuntime.jsx(
        "label",
        {
          htmlFor: switchId,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(LabelContent, {})
        ]
      }
    );
  }
...
var glassModalVariants = classVarianceAuthority.cva(
  [
...
var GlassModal = React4.forwardRef(
  ({
    title,
    description,
    children,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(DialogPrimitive__namespace.Root, { open, onOpenChange, ...props, children: [
      trigger && /* @__PURE__ */ jsxRuntime.jsx(DialogPrimitive__namespace.Trigger, { asChild: true, children: trigger }),
      /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { children: open !== false && /* @__PURE__ */ jsxRuntime.jsxs(DialogPrimitive__namespace.Portal, { forceMount: true, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(DialogPrimitive__namespace.Content, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsxs(
          framerMotion.motion.div,
          {
            ...
            children: [
              ...
              title && /* @__PURE__ */ jsxRuntime.jsx(DialogPrimitive__namespace.Title, { className: "text-xl font-semibold text-white mb-2", children: title }),
              description && /* @__PURE__ */ jsxRuntime.jsx(DialogPrimitive__namespace.Description, { className: "text-sm text-white/60 mb-4", children: description }),
              children
            ]
          }
        ) })
...
var GlassModalTrigger = DialogPrimitive__namespace.Trigger;
var GlassModalClose = DialogPrimitive__namespace.Close;
var glassNavbarVariants = classVarianceAuthority.cva(
  [
...
var glassNavItemVariants = classVarianceAuthority.cva(
  [
...
var GlassNavItem = React4.forwardRef(
...
var MenuIcon = () => /* @__PURE__ */ jsxRuntime.jsx("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M4 6h16M4 12h16M4 18h16" }) });
var CloseIcon2 = () => /* @__PURE__ */ jsxRuntime.jsx("svg", { className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) });
var GlassNavbar = React4.forwardRef(
  ({
    logo,
    children,
    actions,
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx("div", { className: "hidden md:flex items-center gap-1 flex-1 justify-center", children }),
                /* @__PURE__ */ jsxRuntime.jsx("div", { className: "hidden md:flex items-center gap-4", children: actions }),
                /* @__PURE__ */ jsxRuntime.jsx(
                  "button",
                  {
                    ...
                    children: mobileMenuOpen ? /* @__PURE__ */ jsxRuntime.jsx(CloseIcon2, {}) : /* @__PURE__ */ jsxRuntime.jsx(MenuIcon, {})
                  }
                )
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { children: mobileMenuOpen && /* @__PURE__ */ jsxRuntime.jsx(
            framerMotion.motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col p-4 gap-2", children: [
                children,
                actions && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "pt-4 border-t border-white/12 mt-2", children: actions })
              ] })
            }
          ) })
        ]
...
var glassSidebarVariants = classVarianceAuthority.cva(
  [
    "flex flex-col",
    "bg-glass-card/70 backdrop-blur-glass",
...
var glassSidebarItemVariants = classVarianceAuthority.cva(
  [
...
var SidebarContext = React4.createContext(
  void 0
);
var useSidebar = () => {
...
var GlassSidebarItem = React4.forwardRef(({ children, active, icon, href, badge, className, ...props }, ref) => {
  const { collapsed } = useSidebar();
  const content = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    icon && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "shrink-0 w-5 h-5", children: icon }),
    /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { mode: "wait", children: !collapsed && /* @__PURE__ */ jsxRuntime.jsx(
    ...
    badge && !collapsed && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "ml-auto shrink-0", children: badge }),
    active && /* @__PURE__ */ jsxRuntime.jsx(
      framerMotion.motion.div,
      {
  ...
  if (href) {
    return /* @__PURE__ */ jsxRuntime.jsx("a", { href, className: itemClasses, children: content });
  }
  return /* @__PURE__ */ jsxRuntime.jsx("button", { ref, className: itemClasses, ...props, children: content });
});
GlassSidebarItem.displayName = "GlassSidebarItem";
var ChevronIcon = ({ direction }) => /* @__PURE__ */ jsxRuntime.jsx(
  "svg",
  {
...
var GlassSidebar = React4.forwardRef(
  ({
    header,
    footer,
    children,
    ...
    const [internalCollapsed, setInternalCollapsed] = React4.useState(defaultCollapsed);
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(SidebarContext.Provider, { value: { collapsed, setCollapsed }, children: /* @__PURE__ */ jsxRuntime.jsxs(
      framerMotion.motion.aside,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("nav", { className: "flex-1 p-3 space-y-1 overflow-y-auto", children }),
          collapsible && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "p-3 border-t border-white/12", children: /* @__PURE__ */ jsxRuntime.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(ChevronIcon, { direction: collapsed ? "right" : "left" }),
                /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { mode: "wait", children: !collapsed && /* @__PURE__ */ jsxRuntime.jsx(
                  framerMotion.motion.span,
                  {
                    initial: { opacity: 0, width: 0 },
...
var GlassDropdownItem = React4.forwardRef(({ children, icon, shortcut, destructive, className, ...props }, ref) => {
  return /* @__PURE__ */ jsxRuntime.jsxs(
    DropdownMenuPrimitive__namespace.Item,
    {
      ...
      children: [
        ...
        shortcut && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "ml-auto text-xs text-white/40", children: shortcut })
      ]
    }
  );
});
GlassDropdownItem.displayName = "GlassDropdownItem";
var GlassDropdownSeparator = React4.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
...
var GlassDropdownLabel = React4.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
...
var GlassDropdown = React4.forwardRef(
  ({
    trigger,
    children,
    align = "start",
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      DropdownMenuPrimitive__namespace.Root,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { children: /* @__PURE__ */ jsxRuntime.jsx(DropdownMenuPrimitive__namespace.Portal, { children: /* @__PURE__ */ jsxRuntime.jsx(
...
var glassTooltipVariants = classVarianceAuthority.cva(
  [
...
var GlassTooltip = React4.forwardRef(
  ({
    content,
    children,
    variant,
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(TooltipPrimitive__namespace.Provider, { delayDuration, children: /* @__PURE__ */ jsxRuntime.jsxs(
...
var GlassTooltipProvider = TooltipPrimitive__namespace.Provider;
var glassTabsListVariants = classVarianceAuthority.cva(
  [
...
var glassTabsTriggerVariants = classVarianceAuthority.cva(
  [
    "relative px-4 py-2 rounded-lg",
...
var GlassTabsList = React4.forwardRef(
...
var GlassTabsTrigger = React4.forwardRef(({ className, variant, icon, children, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsxs(
...
var GlassTabsContent = React4.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx(
...
var GlassTabs = React4.forwardRef(
...
var glassToastVariants = classVarianceAuthority.cva(
  [
...
var GlassToast = React4.forwardRef(
  ({ title, description, variant = "default", action, onClose }, ref) => {
    return /* @__PURE__ */ jsxRuntime.jsxs(
      framerMotion.motion.div,
      {
        ...
        "aria-live": "polite",
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "shrink-0 mt-0.5", children: variantIcons[variant ?? "default"] }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 min-w-0", children: [
            title && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm font-medium text-white", children: title }),
            description && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm text-white/60 mt-0.5", children: description }),
...
var ToastProvider = ({
  ...
  const clearToasts = React4.useCallback(() => {
    setToasts([]);
  }, []);
  return /* @__PURE__ */ jsxRuntime.jsxs(
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { mode: "popLayout", children: toasts.map((toast) => /* @__PURE__ */ jsxRuntime.jsx(
              GlassToast,
              {
                ...toast,
...
var glassProgressVariants = classVarianceAuthority.cva(
  [
...
var glassProgressBarVariants = classVarianceAuthority.cva(
...
var GlassProgress = React4.forwardRef(
  ({
    value = 0,
    indeterminate = false,
    showLabel = false,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cn("w-full", className), children: [
      showLabel && labelPosition === "outside" && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex justify-between items-center mb-2", children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-sm text-white/70", children: "Progress" }),
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-sm font-medium text-white", children: formatLabel(clampedValue) })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsx(
        "div",
        {
          ...
          children: indeterminate ? /* @__PURE__ */ jsxRuntime.jsx(
            ...
            framerMotion.motion.div,
            {
              ...
              transition: { duration: 0.3, ease: [0.4, 0, 0.2, 1] },
              children: showLabel && labelPosition === "inside" && size === "lg" && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "absolute inset-0 flex items-center justify-center text-xs font-medium text-white", children: formatLabel(clampedValue) })
            }
          )
        }
      )
...
var GlassCircularProgress = React4.forwardRef(
  ({
    value = 0,
    indeterminate = false,
    size = 48,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative inline-flex items-center justify-center", children: [
      /* @__PURE__ */ jsxRuntime.jsxs(
        "svg",
        {
          ref,
      ...
      (showLabel || label) && !indeterminate && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: label || /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "text-xs font-medium text-white", children: [
...
var glassAvatarVariants = classVarianceAuthority.cva(
  [
...
var statusVariants = classVarianceAuthority.cva("absolute border-2 border-glass-dark rounded-full", {
  variants: {
    status: {
...
var DefaultFallbackIcon = () => /* @__PURE__ */ jsxRuntime.jsx(
  "svg",
  {
...
var GlassAvatar = React4.forwardRef(
  ({
    src,
    alt,
    fallback,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          showFallback ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "font-medium text-white select-none", children: fallback ? getInitials(fallback) : fallbackIcon ? fallbackIcon : /* @__PURE__ */ jsxRuntime.jsx(DefaultFallbackIcon, {}) }) : /* @__PURE__ */ jsxRuntime.jsx(
            "img",
            {
              src,
...
var GlassAvatarGroup = React4.forwardRef(
  ({ max, size = "md", children, className, ...props }, ref) => {
    const childArray = React4__default.default.Children.toArray(children);
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          visibleChildren.map((child, index) => /* @__PURE__ */ jsxRuntime.jsx(
            "div",
            {
              className: "relative ring-2 ring-glass-dark rounded-full",
              style: { zIndex: visibleChildren.length - index },
              children: React4__default.default.cloneElement(child, { size })
            },
            index
          )),
          excess > 0 && /* @__PURE__ */ jsxRuntime.jsx(
            "div",
            {
              className: "relative ring-2 ring-glass-dark rounded-full",
              style: { zIndex: 0 },
...
var glassBadgeVariants = classVarianceAuthority.cva(
  [
...
var GlassBadge = React4.forwardRef(
  ({
    children,
    variant,
    size,
...
var SearchIcon = () => /* @__PURE__ */ jsxRuntime.jsx("svg", { className: "w-5 h-5 text-white/50", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" }) });
var overlayVariants2 = {
  hidden: { opacity: 0 },
  visible: { opacity: 1 }
};
var contentVariants3 = {
  hidden: { opacity: 0, scale: 0.95, y: -20 },
  visible: { opacity: 1, scale: 1, y: 0 }
};
var GlassCommandPalette = React4.forwardRef(
  ({
    commands,
    open: controlledOpen,
    onOpenChange,
    ...
    const defaultFilter = (command, searchTerm) => {
      const normalizedSearch = searchTerm.toLowerCase();
      return command.label.toLowerCase().includes(normalizedSearch) || command.description?.toLowerCase().includes(normalizedSearch) || command.group?.toLowerCase().includes(normalizedSearch);
    };
    const filterFn = customFilter ?? defaultFilter;
    const filteredCommands = search ? commands.filter((cmd) => filterFn(cmd, search)) : commands;
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(DialogPrimitive__namespace.Root, { open, onOpenChange: setOpen, children: /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { children: open && /* @__PURE__ */ jsxRuntime.jsxs(DialogPrimitive__namespace.Portal, { forceMount: true, children: [
      /* @__PURE__ */ jsxRuntime.jsx(DialogPrimitive__namespace.Overlay, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(
        framerMotion.motion.div,
        {
      ...
      /* @__PURE__ */ jsxRuntime.jsx(DialogPrimitive__namespace.Content, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsxs(
        framerMotion.motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3 px-4 py-3 border-b border-white/12", children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx("kbd", { className: "hidden sm:inline-flex items-center gap-1 px-2 py-1 text-xs text-white/40 bg-white/5 rounded border border-white/10", children: "ESC" })
            ] }),
            /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                ...
                role: "listbox",
                children: flatCommands.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "py-8 text-center text-white/50", children: emptyMessage }) : Object.entries(groupedCommands).map(([group, items]) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mb-2 last:mb-0", children: [
                  /* @__PURE__ */ jsxRuntime.jsx("div", { className: "px-3 py-2 text-xs font-medium text-white/40 uppercase", children: group }),
                  items.map((command) => {
                    ...
                    return /* @__PURE__ */ jsxRuntime.jsxs(
                      "button",
                      {
                        ...
                        children: [
                          command.icon && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "shrink-0 w-5 h-5", children: command.icon }),
                          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 min-w-0", children: [
                            /* @__PURE__ */ jsxRuntime.jsx("div", { className: "font-medium truncate", children: command.label }),
                            command.description && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-sm text-white/50 truncate", children: command.description })
                          ] }),
                          command.shortcut && /* @__PURE__ */ jsxRuntime.jsx("kbd", { className: "shrink-0 px-2 py-1 text-xs text-white/40 bg-white/5 rounded border border-white/10", children: command.shortcut })
                        ]
                      },
                      command.id
                    );
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center justify-between px-4 py-2 border-t border-white/12 text-xs text-white/40", children: [
              /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-4", children: [
                /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntime.jsx("kbd", { className: "px-1.5 py-0.5 bg-white/5 rounded border border-white/10", children: "\u2191\u2193" }),
              ...
              /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntime.jsx("kbd", { className: "px-1.5 py-0.5 bg-white/5 rounded border border-white/10", children: "\u2318K" }),
                /* @__PURE__ */ jsxRuntime.jsx("span", { children: "Toggle" })
              ] })
            ] })
          ]
        }
...
function useModal(options = {}) {
  ...
  const [isOpen, setIsOpen] = React4.useState(defaultOpen);
...
var STORAGE_KEY = "glass-ui-theme";
var ATTRIBUTE = "class";
function useTheme(options = {}) {
  ...
  const [theme, setThemeState] = React4.useState(getInitialTheme);
  const getSystemTheme = React4.useCallback(() => {
    if (typeof window === "undefined") {
      return "dark";
    }
...
exports.GlassAvatar = GlassAvatar;
exports.GlassAvatarGroup = GlassAvatarGroup;
exports.GlassBadge = GlassBadge;
exports.GlassButton = GlassButton;
exports.GlassCard = GlassCard;
exports.GlassCheckbox = GlassCheckbox;
exports.GlassCircularProgress = GlassCircularProgress;
exports.GlassCommandPalette = GlassCommandPalette;
exports.GlassDropdown = GlassDropdown;
exports.GlassDropdownItem = GlassDropdownItem;
exports.GlassDropdownLabel = GlassDropdownLabel;
exports.GlassDropdownSeparator = GlassDropdownSeparator;
exports.GlassInput = GlassInput;
exports.GlassModal = GlassModal;
exports.GlassModalClose = GlassModalClose;
exports.GlassModalTrigger = GlassModalTrigger;
exports.GlassNavItem = GlassNavItem;
exports.GlassNavbar = GlassNavbar;
exports.GlassProgress = GlassProgress;
exports.GlassSelect = GlassSelect;
exports.GlassSidebar = GlassSidebar;
exports.GlassSidebarItem = GlassSidebarItem;
exports.GlassSwitch = GlassSwitch;
exports.GlassTabs = GlassTabs;
exports.GlassTabsContent = GlassTabsContent;
exports.GlassTabsList = GlassTabsList;
exports.GlassTabsTrigger = GlassTabsTrigger;
exports.GlassTextarea = GlassTextarea;
exports.GlassToast = GlassToast;
exports.GlassTooltip = GlassTooltip;
exports.GlassTooltipProvider = GlassTooltipProvider;
